...
@Component({
  selector: 'app-candidatelist-regis',
  templateUrl: './candidatelist-regis.component.html',
  styleUrls: ['./candidatelist-regis.component.scss']
})
export class CandidatelistRegisComponent implements OnInit {
